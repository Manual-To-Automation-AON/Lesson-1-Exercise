# Manual to Automation @ <a href="https://aon.co.uk/"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Logo_Aon_Corporation.svg/2560px-Logo_Aon_Corporation.svg.png" alt="AON" height="27" /></a> - Lesson 1 - Exercise
...
```sh
git clone https://github.com/Manual-To-Automation-AON/Lesson-1-Exercise.git.
```
